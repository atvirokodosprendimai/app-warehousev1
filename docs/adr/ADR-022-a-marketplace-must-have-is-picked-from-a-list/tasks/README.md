...
| T4 | Pick each must-have from a dropdown on the offer editor | done | — | `go test ./internal/export/ -run '^TestEBayPrefersTheOffersOwn'` + `bash scripts/smoke.sh` + `bash scripts/browser.sh marketplace` + named assertions |
